...
public class ReservationRequest {
    ...
    public String toString() {
        ...
        return "ReservationRequest [flightId=" + this.flightId + ", passengerFirstName=" + this.passengerFirstName
                + ", passengerLastName=" + this.passengerLastName + ", passengerEmail=" + this.passengerEmail
                + ", passengerPhone=" + this.passengerPhone + ", nameOnTheCard=" + this.nameOnTheCard + ", cardNumber="
                + this.cardNumber + ", expirationDate=" + this.expirationDate + ", securityCode=" + this.securityCode + "]";
    }
