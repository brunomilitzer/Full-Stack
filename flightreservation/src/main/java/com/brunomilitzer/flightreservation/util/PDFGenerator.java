...
public class PDFGenerator {
    ...
    public void generateItinerary(final Reservation reservation, final String filePath) {

        LOGGER.error("Inside generateItinerary()");
    ...
    private Element generateTable(final Reservation reservation) {
